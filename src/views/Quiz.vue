<template>
  <div class="d-flex justify-content-center">
    ...
    <div v-if="showScore">
        ...
        <br>
        <br>
        <b-button @click="$emit('reload')">Restart Quiz</b-button>
        </b-card>
    </div>
    ...
    class="mb-2"
        ...
        <b-card-text>
            ...
            Since it is open source feel free to contribute to this simple quiz Application here: <a target="_blank" href="https://github.com/antonin-alves/the-game-of-cybersecurity"> Github Repo </a>
        </b-card-text>
